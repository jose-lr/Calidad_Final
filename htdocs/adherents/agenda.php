...
$sortfield = GETPOST("sortfield", 'ALPH');
$sortorder = GETPOST("sortorder", 'ALPH');
...
{
    // Cancel
    if (GETPOST('cancel', 'ALPH') && !empty($backtopage))
    {
    ...
    if (GETPOST('button_removefilter_x', 'ALPH') || GETPOST('button_removefilter.x', 'ALPH') || GETPOST('button_removefilter', 'ALPH')) 
    {
        $actioncode = '';
        $search_agenda_label = '';
    }
