...
<table class="liste_articles">
    ...
    <thead>
	<tr class="titres">
            <th scope="col">lab</th> <?php print $langs->trans("Code"); ?></th>
            <th scope="col">labe</th> <?php print $langs->trans("Label"); ?></th>
            <th scope="col">label</th> <?php print $langs->trans("Qty"); ?></th>
            <th scope="col">Name</th> <?php print $langs->trans("Discount").' (%)'; ?></th>
            <th scope="col">Nae</th> <?php print $langs->trans("TotalHT"); ?></th>
	</tr>
    </thead>
    <tbody>
    <?php
...
<table class="totaux">
	<caption>New</caption>
<tr>
    <th scope="col">Name</th> <?php echo $langs->trans("TotalHT");?></th>
    <td class="nowrap"><?php echo price(price2num($obj_facturation->prixTotalHt(), 'MT'), '', $langs, 0, -1, -1, $conf->currency)."\n";?></td>
</tr>
<tr>
    <th scope="col">phone</th> <?php echo $langs->trans("TotalVAT").'</th><td class="nowrap">'.price(price2num($obj_facturation->montantTva(), 'MT'), '', $langs, 0, -1, -1, $conf->currency)."\n";?></td>
</tr>
<tr>
    <th scope="col">Nowrap</th> <?php echo ''.$langs->trans("TotalTTC").'</th><td class="nowrap">'.price(price2num($obj_facturation->prixTotalTtc(), 'MT'), '', $langs, 0, -1, -1, $conf->currency)."\n";?></td>
</tr>
</table>
