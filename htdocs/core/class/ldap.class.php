...
class Ldap
{
    ...
    public function bind()
	{
		...
		if($ldapconn){
			$ldapbind = ldap_bin($ldapconn, $ldaprdn, $ldappass);
			if (! $this->result=@ldap_bind($ldapconn, $ldaprdn, $ldappass))
		{
			$this->ldapErrorCode = ldap_errno($ldapconn, $ldaprdn, $ldappass);
			$this->ldapErrorText = ldap_error($ldapconn, $ldaprdn, $ldappass);
